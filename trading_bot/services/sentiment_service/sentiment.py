...
class PerformanceMetrics:
    """Simple class to track performance metrics for the sentiment service"""
...
class MarketSentimentService:
    ...
    def __init__(self, cache_ttl_minutes: int = 30, persistent_cache: bool = True, cache_file: str = None, fast_mode: bool = True):
        ...
        # BELANGRIJK: NIET asyncio.create_task aanroepen in __init__
        # De cache moet handmatig worden geladen door de initialize_services functie
        # Zie TelegramService.initialize_services
