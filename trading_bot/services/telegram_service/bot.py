            ...
            conv_handler = ConversationHandler(
                ...
                states={
                    ...
                    CHOOSE_MARKET: [
                        ...
                        CallbackQueryHandler(self.market_signals_callback, pattern='^market_signals_'),
                        CallbackQueryHandler(self.back_to_menu_callback, pattern='^back_menu$'),
                        CallbackQueryHandler(self.back_to_analysis, pattern='^back_to_analysis$')
                    ],
                    CHOOSE_INSTRUMENT: [
                        CallbackQueryHandler(self.instrument_callback, pattern='^instrument_'),
                        CallbackQueryHandler(self.instrument_signals_callback, pattern='^instrument_signals_'),
