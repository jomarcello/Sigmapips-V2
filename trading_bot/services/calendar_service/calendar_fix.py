...
class EconomicCalendarService:
    ...
    def _generate_mock_calendar_data(self, currencies, date):
        ...
        # Check if the date is April 15, 2025
        if current_date.strftime("%Y-%m-%d") == "2025-04-15" or current_date.month == 4 and current_date.day == 15 and current_date.year == 2025:
            self.logger.info("Using hard-coded events for April 15, 2025")
            # Return the exact events for this date based on the provided list
            return {
                "USD": [
                    {"time": "00:00", "event": "Fed Waller Speaks", "impact": "High"},
                    {"time": "05:00", "event": "FOMC Member Harker Speaks", "impact": "High"},
                    {"time": "19:30", "event": "NY Empire State Manufacturing Index (Apr)", "impact": "High", "forecast": "-14.80", "previous": "-20.00"},
                    {"time": "22:30", "event": "52-Week Bill Auction", "impact": "Low", "previous": "3.945%"},
                    {"time": "22:35", "event": "FOMC Member Barkin Speaks", "impact": "High"},
                    {"time": "06:40", "event": "FOMC Member Bostic Speaks", "impact": "High"},
                ],
                "NZD": [
                    {"time": "05:45", "event": "FPI (MoM) (Mar)", "impact": "Medium", "previous": "-0.5%", "actual": "0.5%"},
                    {"time": "18:45", "event": "FPI", "impact": "Low"},
                ],
                "GBP": [
                    {"time": "06:01", "event": "BRC Retail Sales Monitor (YoY) (Mar)", "impact": "Medium", "forecast": "0.7%", "previous": "0.9%", "actual": "0.9%"},
                    {"time": "13:00", "event": "Average Earnings ex Bonus (Feb)", "impact": "High", "forecast": "6.0%", "previous": "5.9%"},
                    {"time": "13:00", "event": "Unemployment Rate (Feb)", "impact": "High", "forecast": "4.4%", "previous": "4.4%"},
                ],
                "AUD": [
                    {"time": "08:30", "event": "RBA Meeting Minutes", "impact": "Medium"},
                ],
                "EUR": [
                    {"time": "06:00", "event": "ECOFIN Meetings", "impact": "Low"},
                    {"time": "13:00", "event": "German WPI (MoM) (Mar)", "impact": "Medium", "forecast": "0.2%", "previous": "0.6%"},
                    {"time": "16:00", "event": "German ZEW Economic Sentiment (Apr)", "impact": "High", "forecast": "10.6", "previous": "51.6"},
                    {"time": "16:00", "event": "Industrial Production (MoM) (Feb)", "impact": "High", "forecast": "0.1%", "previous": "0.8%"},
                    {"time": "23:00", "event": "ECB President Lagarde Speaks", "impact": "High"},
                ],
                "JPY": [
                    {"time": "00:30", "event": "Capacity Utilization", "impact": "Low"},
                    {"time": "00:30", "event": "Industrial Production", "impact": "Medium"},
                ],
                "CAD": [
                    {"time": "08:30", "event": "New Motor Vehicle Sales", "impact": "Low"},
                    {"time": "08:30", "event": "Wholesale Sales", "impact": "Medium"},
                    {"time": "19:30", "event": "CPI (YoY) (Mar)", "impact": "High", "forecast": "2.6%", "previous": "2.6%"},
                    {"time": "19:30", "event": "Manufacturing Sales (MoM) (Feb)", "impact": "Medium", "forecast": "-0.1%", "previous": "1.7%"},
                ],
                "CHF": [
                    {"time": "02:30", "event": "PPI", "impact": "Medium"},
                    {"time": "02:30", "event": "PPI", "impact": "Low"},
                ]
            }
