...
# 100% HARDCODED vlag-valuta mapping
# NOOIT WIJZIGEN - Dit is de absolute waarheid
CURRENCY_FLAG = {
    ...
    async def get_events(self, instrument: str) -> Dict:
        ...
        try:
            ...
            for currency, currency_events in calendar_data.items():
                ...
                # Gebruik ALTIJD de flag uit onze ABSOLUTE lookup
            ...
            explanation += ", ".join([f"{ABSOLUTE_VLAG_VALUTA.get(c, '')} {c}" for c in currencies])
