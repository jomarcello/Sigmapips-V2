...
DO NOT omit any sections. The sentiment values (Overall Sentiment, Bullish, Bearish, Neutral percentages) MUST be clearly indicated EXACTLY as shown in the format.

The "Bullish: XX%" format MUST be preserved exactly as shown. Do not vary this format. Do not add or omit spaces. DO NOT CHANGE THE FORMAT AT ALL.
"""
