...
class MarketSentimentService:
    ...
    def __init__(self, cache_ttl_minutes: int = 60, persistent_cache: bool = True, cache_file: str = None, fast_mode: bool = True):
        """
        Initialize the market sentiment service
        
        Args:
            cache_ttl_minutes: Time in minutes to keep sentiment data in cache (default: 60)
